...
export interface IServiceProvider {
     ...
     */
    contains<T extends ServiceDefinition<any>>(serviceDefinition: new () => T): boolean;
    /**
     * Returns if the given service of the {@link serviceDefinition} is unknown by the service provider.
     */
    containsNot<T extends ServiceDefinition<any>>(serviceDefinition: new () => T): boolean;
    /**
     * Returns the service of the {@link serviceDefinition} or throws an exception if the service type is unknown.
     */
    fetch<T extends ServiceDefinition<any>, TServiceType extends keyof T>(serviceDefinition: new () => T): T[TServiceType];
    /**
     * Returns the service of the {@link serviceDefinition} or {@link undefined} if the service type is unknown.
     */
    fetchOrNull<T extends ServiceDefinition<any>, TServiceType extends keyof T>(serviceDefinition: new () => T): T[TServiceType] | undefined;
    /**
     ...
     */
    put<T extends ServiceDefinition<any>, TServiceType extends keyof T>(serviceDefinition: new () => T, serviceInstance: T[TServiceType]): void;
    /**
     * Removes the {@link serviceDefinition} which means the services cannot be fetched anymore.
     */
    remove<T extends ServiceDefinition<any>>(serviceDefinition: new () => T): void;
    /**
     ...
     */
    register<T extends ServiceDefinition<any>, TServiceType extends keyof T>(serviceDefinition: new () => T, concreteServiceType: new () => T[TServiceType], serviceInstanceType?: ServiceInstanceType): void;
}
